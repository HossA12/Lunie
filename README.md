...
Physically-inspired phase shading based on CSV data
Smooth parallax motion + blink animation
Dark, minimal theme (CustomTkinter)
Optional background music (auto-plays if a track is present)
Windows: auto-creates a Desktop shortcut on first run
